...
{\normalsize <X-Arbeit> am Institut f�r Informatik der Freien Universit�t Berlin, Arbeitsgruppe Software Engineering}\\[6ex]
<Titel>}

\author{Nikls Klein\\
{\normalsize Matrikelnummer: 4387959}\\
{\normalsize \mailto{niklas.klein@fu-berlin.de}}\\\\
{\normalsize Betreuer: Prof. Dr. Lutz Prechelt}\\
{\normalsize Eingereicht bei: }}

\date{Berlin, 1. Juni 2015}
